...
import { ApiUrl, AppConstants, ImageUrl } from "../shared/app-constants";
...
export class AreasHttpService implements BaseHttpService {
    ...
    apiURL: string = AppConstants.app_environment == "Local" ? ApiUrl.Local : ApiUrl.UAT;
    imageURL: string = AppConstants.app_environment == "Local" ? ImageUrl.Local : ImageUrl.UAT;

    apiRoot: string = AppConstants.app_environment == "Local" ? ApiUrl.Local :
        (AppConstants.app_environment == "Public" ? this.apiURL : "");

    imageRoot: string = AppConstants.app_environment == "Local" ? this.imageURL :ImageUrl.UAT;
